    ...
    <div class="bg-white rounded-lg shadow-lg w-11/12 max-w-lg p-6 relative">
        ...
        <form id="projectForm">
            ...
            <div class="flex justify-end">
                <button type="button" onclick="closeProjectModal()" class="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600 transition mr-2">
                    Cancelar
                </button>
        ...
        <button type="button" onclick="closeProjectModal()" class="absolute top-4 right-4 text-gray-600 hover:text-gray-900 transition">
