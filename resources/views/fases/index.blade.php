...
<body class="antialiased bg-gray-50 dark:bg-gray-300 flex">
    ...
    <div class="flex-1 ml-[250px]"> <!-- Ajustamos el margen izquierdo para respetar el ancho del sidebar -->
        ...
        <!-- Main Section -->
        <main class="p-6">  
            <h1 class="mb-4 text-2xl font-extrabold leading-none tracking-tight text-gray-900 md:text-2xl lg:text-2xl dark:text-black">Gestión de <mark class="px-1 text-white bg-blue-600 rounded dark:bg-blue-500">fases</mark> over your days</h1>
